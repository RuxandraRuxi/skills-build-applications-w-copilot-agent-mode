...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        activities = [
            ...
            {'user': 'batman@dc.com', 'type': 'run', 'distance': 10}
        ]
        ...
        workouts = [
            ...
            {'user': 'ironman@marvel.com', 'workout': 'Cycling', 'reps': 100},
            {'user': 'wonderwoman@dc.com', 'workout': 'Swimming', 'reps': 30},
            {'user': 'batman@dc.com', 'workout': 'Running', 'reps': 60}
        ]
